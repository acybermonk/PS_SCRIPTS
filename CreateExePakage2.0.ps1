            ...
            if ($confirmResult -eq "y" -or $confirmResult -eq "yes"){
                ...
                if (Test-Path -Path "$($directorySet)\$($OutputFileName)"){
                    ...
                    if ($overRiteCont -eq "y"){
                        ...
                        Write-Host "Cancelling Creation. Closing App." -ForegroundColor Red
                    ...
                    if (Test-Path -Path "$($directorySet)\$($OutputFileName)"){
                        ...
                        Write-Host "Cancelling Creation." -ForegroundColor Red
                        Start-Sleep -Seconds 2
                        Exit
                    }
                }
                ...
                Write-Host "Ibvalid Answer. Closing App." -ForegroundColor Red
                Start-Sleep -Seconds 5
                Exit
            }
